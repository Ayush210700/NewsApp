...
const News = (props)=> {
    ...
    useEffect(() => {
        document.title = `${captialize(props.category)} - Taza Khabar`
        updateNews();
    ...
    return (
      <>
        <h1 className='text-center' style={{margin:'35px', marginTop:'90px'}}>Taza Khabar - Top {captialize(props.category)} HeadLines</h1>
        {loading && <Spinner/>}
